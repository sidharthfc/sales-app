...
export const endpoints = {
  ...
  listTerritories:         '/api/method/route_sales.api.crm.list_territories',
  listAllTerritories:      '/api/method/route_sales.api.crm.list_all_territories',
  listCountries:           '/api/method/route_sales.api.crm.list_countries',
  listStates:              '/api/method/route_sales.api.crm.list_states',
  ...
  saveQuotationDraft:      '/api/method/route_sales.api.crm.save_quotation_draft',
  submitQuotation:         '/api/method/route_sales.api.crm.submit_quotation',
  discardQuotationDraft:   '/api/method/route_sales.api.crm.discard_quotation_draft',
  cancelQuotation:         '/api/method/route_sales.api.crm.cancel_quotation',
  ...
  getQuotationDetail:      '/api/method/route_sales.api.crm.get_quotation_detail',
